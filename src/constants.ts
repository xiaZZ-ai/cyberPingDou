...
> = {
  ...
  "CoCo-293": { brandId: "coco", brandLabel: "CoCo", aliases: ["可可", "CoCo 色卡"] },
  "漫漫": { brandId: "manman", brandLabel: "漫漫", aliases: ["漫漫色卡"] },
  "小舞-290": { brandId: "xiaowu", brandLabel: "小舞", aliases: ["小舞色卡"] },
  "咪小窝-292": { brandId: "mixiaowo", brandLabel: "咪小窝", aliases: ["咪小窝色卡"] },
